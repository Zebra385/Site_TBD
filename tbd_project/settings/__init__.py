"""
Django settings for tbd_project project.
...
SECRET_KEY = '@03&jbr70%ydm+zw^89t5w^y@&l29&9@xpw=l7x-pwwuyw@f32'
...
WSGI_APPLICATION = 'tbd_project.wsgi.application'
